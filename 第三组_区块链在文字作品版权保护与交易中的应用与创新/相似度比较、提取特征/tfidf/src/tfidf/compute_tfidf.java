...
public class compute_tfidf {
    ...
    public static ArrayList<String> cutWords(String file) throws IOException{
        ...
        String text = compute_tfidf.readFile(file);
...
//                System.out.println(word.toString());
    ...
    public static HashMap<String, Float> tf(ArrayList<String> cutwords){
        ...
        HashMap<String, Integer> intTF = compute_tfidf.normalTF(cutwords); 
...
//            System.out.println(entry.getKey().toString() + " = "+  Float.parseFloat(entry.getValue().toString()) / wordLen);
    ...
    public static HashMap<String, HashMap<String, Integer>> normalTFAllFiles(String dirc) throws IOException{
        ...
        List<String> filelist = compute_tfidf.readDirs(dirc);
        for(String file : filelist){
            HashMap<String, Integer> dict = new HashMap<String, Integer>();
            ArrayList<String> cutwords = compute_tfidf.cutWords(file); //get cut word for one file
            
            dict = compute_tfidf.normalTF(cutwords);
    ...
    public static HashMap<String,HashMap<String, Float>> tfAllFiles(String dirc) throws IOException{
        ...
        for(String file : filelist){
            ...
            ArrayList<String> cutwords = compute_tfidf.cutWords(file); //get cut words for one file
            
            dict = compute_tfidf.tf(cutwords);
            allTF.put(file, dict);
        }
        return allTF;
    }
...
//                System.out.print(entry.getKey().toString() + " = " + entry.getValue().toString() + ", ");
    ...
    public static void main(String[] args) throws IOException {
    	...
    	String file = "C:/Users/14760/Desktop/content";
